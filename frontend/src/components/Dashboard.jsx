...
export default function Dashboard() {
  ...
  return (
    <div className="safari-theme" style={{ width: '100%', minHeight: '100vh', background: '#081c15', position: 'relative', overflowX: 'hidden' }}>
      ...
      {/* ── DASHED ACCENT LINE — mirrors the luggage-tag left-column border on all tabs (desktop) ── */}
      {!isMobile && activeTab !== 'itineraries' && (
        <div style={{
          position: 'fixed',
          /* same x-position as the luggage-tag left-column right border: 50% - 360px + 100px */
          left: 'calc(50% - 260px)',
          top: 0, bottom: 0, width: 0,
          borderLeft: '2px dashed rgba(255,255,255,0.13)',
